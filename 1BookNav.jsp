	...
	<div class="container-fluid">
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav me-auto mb-2 mb-lg-0">
				<li class="nav-item"><a class="nav-link active btn-warning" href="Mainpage.jsp">Books</a></li>
				<li class="nav-item"><a class="nav-link active" href="Writer.jsp">Writers</a></li>
				<li class="nav-item"><a class="nav-link active" href="Publish.jsp">Publishers</a></li>
				<li class="nav-item"><a class="nav-link active" href="Blog.jsp">Blog</a></li>
				<li class="nav-item"><a class="nav-link active" href="Blog.jsp">Online reading</a></li>
